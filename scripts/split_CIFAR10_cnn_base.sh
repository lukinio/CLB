...
CUDA_VISIBLE_DEVICES=$GPUID python -u iBatchLearn.py --dataset CIFAR10 --train_aug --gpuid $GPUID \
        --repeat $REPEAT --incremental_class --optimizer Adam --force_out_dim 10 --no_class_remap \
        --first_split_size 2 --other_split_size 2 --schedule 50 --batch_size 100 \
        --model_name cnn --model_type cnn --agent_type customization  --agent_name EWC \
        --lr 0.001 --reg_coef 2 | tee ${OUTDIR}/EWC_ic.log